//lexical analyser in c++ using regex
...
// define token roles - identifiers, numbers, keywords, operators and separators
...
//lexical analyser for mapping tokens and roles
void lex(const string &str){

    // for all words(strings) found in a line of code, match with the role it qualifies
